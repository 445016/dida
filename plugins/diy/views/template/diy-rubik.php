                ...
                style_list: [
                    {
                        ...
                        icon: '<?= $pluginUrl ?>/images/rubik-0.png',
                    },
                    {
                        name: '2张图',
                        height: 360,
                        ...
                        icon: '<?= $pluginUrl ?>/images/rubik-1.png',
                    },
                    {
                        name: '3张图',
                        height: 360,
                        ...
                        icon: '<?= $pluginUrl ?>/images/rubik-2.png',
                    },
                    {
                        name: '4张图',
                        height: 360,
                        ...
                        icon: '<?= $pluginUrl ?>/images/rubik-3.png',
                    },
                    {
                        name: '2张图平分',
                        height: 240,
                        ...
                        icon: '<?= $pluginUrl ?>/images/rubik-4.png',
                    },
                    {
                        name: '3张图平分',
                        height: 240,
                        ...
                        icon: '<?= $pluginUrl ?>/images/rubik-5.png',
                    },
                    {
                        name: '4张图左右平分',
                        height: 186,
                        ...
                        icon: '<?= $pluginUrl ?>/images/rubik-6.png',
                    },
                    {
                        name: '4张图上下平分',
                        height: 372,
                        ...
                        icon: '<?= $pluginUrl ?>/images/rubik-7.png',
                    },
                    {
                        name: '自定义魔方',
                        height: 372,
                        ...
                        icon: '<?= $pluginUrl ?>/images/rubik-8.png',
                    },
                ]
            };
        },
